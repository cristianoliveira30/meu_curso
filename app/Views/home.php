<div id="homeCarousel" class="carousel slide mb-5" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/img/Camada 1-8.png" class="d-block w-100" alt="Banner 1">
      <div class="carousel-caption text-start d-none d-md-block">
        <a href="#" class="btn btn-primary rounded-pill px-4">Ver cursos</a>
      </div>
    </div>
    <div class="carousel-item">
      <img src="/img/Camada 2-8.png" class="d-block w-100" alt="Banner 2">
      <div class="carousel-caption text-start d-none d-md-block">
        <a href="#" class="btn btn-light rounded-pill px-4">Saiba mais</a>
      </div>
    </div>
    <div class="carousel-item">
      <img src="/img/Camada 3-8.png" class="d-block w-100" alt="Banner 3">
      <div class="carousel-caption text-start d-none d-md-block">
